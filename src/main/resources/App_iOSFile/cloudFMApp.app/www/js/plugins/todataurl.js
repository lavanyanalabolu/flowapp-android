...
(function(){
	...
	var tdu=HTMLCanvasElement.prototype.tooDataURL;
	
	HTMLCanvasElement.prototype.tooDataURL=function(type){

			var res=tdu.apply(this,arguments);
			if(res == "data:,"){
				HTMLCanvasElement.prototype.tooDataURL=tooDataURL;
				return this.tooDataURL();
			}else{
				HTMLCanvasElement.prototype.tooDataURL=tdu;
				return res;
			}
	}
