...
public  class sendMail {
	...
	public  static void sendEmailToClient() throws Exception
	{
		...
		final String subject = prop.getProperty("subject") +" " + KeywordUtil.verifyCurrentDate();
		...
		fallback = prop.getProperty("fallback");
	          ...
	          if(!"".equals(port))
	            ...
	            messageBodyPart.setText("Hi Team, \n Please find the attachment for Email Report for andriodSuite:- "+prop.getProperty("SuiteName")+" \n  Note:This is an auto generated email \n \n Thanks & Regards \n Test Engineer");
	            ...
	            if(new File(System.getProperty("user.dir")+"/ExecutionReports/ExecutionReports").exists())
	            {
	            	Utility.delDirectory(new File(System.getProperty("user.dir")+"/ExecutionReports/ExecutionReports"));
	            	    ...
	            	    if(((Utility.GetValue("HTMLReport")).toUpperCase()).contains("Y"))
	            	    {
	            	    	copyDirectoryData("HtmlReport","HtmlReport");
	            	    }
	            	    
	            	    
	            	    if(((Utility.GetValue("ExcelReport")).toUpperCase()).contains("Y"))
	            	    {
	            	    	copyDirectoryData("ExcelReport","ExcelReport");
	            	    }
	            	    
	            	    if(((Utility.GetValue("Logs")).toUpperCase()).contains("Y"))
	            	    {
	            	    	copyDirectoryData("Logs","Logs");
	            	    }
	            	    
	            	
	            	DriverUtil.createZipFile();
