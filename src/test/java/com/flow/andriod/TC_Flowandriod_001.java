...
public class TC_Flowandriod_001 extends AndroidApplicationFunctions
{
	...
	*/
	public void TestValidation() throws Exception{
		try{
			...
			NavigateToLoginPage();
			allowPopup();
			LogintoTheApplication(DriverUtil.GetValue("username"),DriverUtil.GetValue("password"));
			switchEnvironment();
			ClickCreateNewProject();
			CreateAproject((FetchDatfromexcel("andriod", testCaseID, "ProjectName")),(FetchDatfromexcel("andriod", testCaseID, "ProjectVisibility")));
			taskCreation(FetchDatfromexcel("andriod", testCaseID, "Taskname"),FetchDatfromexcel("andriod", testCaseID, "ProjectName"));
			//assigneeSelection();
			subscriber(FetchDatfromexcel("andriod", testCaseID,"subscriber"));
			clikToCreate();
			GoToAccountDetails();
			LogoutOfapplication();
