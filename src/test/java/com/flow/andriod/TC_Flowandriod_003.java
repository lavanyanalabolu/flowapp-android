...
public class TC_Flowandriod_003 extends AndroidApplicationFunctions
{
	...
	*/
	public void TestValidation() throws Exception{
		try{
			...
			// login with assignee credentials and check his cathcup funcatinality
			NavigateToLoginPage();
			allowPopup();
			LogintoTheApplication((FetchDatfromexcel("andriod", testCaseID, "AssignUsername")),(FetchDatfromexcel("andriod", testCaseID, "assigneePassword")));
			switchEnvironment();
			Assert.assertTrue(ClickonHowitworksAssignee(FetchDatfromexcel("andriod", testCaseID, "tasknameAssigned")));
